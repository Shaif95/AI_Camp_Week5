...
st.pyplot(fig)
st.text("We wanted to see whether smoking would have an effect on people's sleep quality. Our data showed that the proportion of people who smoked was higher in people who had worse sleep quality, likely since the substances found in cigarettes like nicotine can disrupt sleep and act as a stimulant.")
...
fig = px.scatter(df, x = "Sleep efficiency", y = "Caffeine consumption", color = "Gender")
...
fig = px.scatter(df, x = "Caffeine consumption", y = "REM sleep percentage", color = "Gender")
